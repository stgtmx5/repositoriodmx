...
function CrearPanel(){
	...
	//Application.UIShortCuts.CreateAction("P_Fin_A60","Buscar Cuenta",0,"","","","UIFinanzas.Adjuntos_",0,"","","",0);
...
function RedimensionarColDetalleCorte(BrwName){
 ...
 function ProcesarReporte(AXForm,Destino){
	...
	/*switch(ObjPoliza.Tipo){
		//Comentado, unicamente se imprimirá un reporte
		//Ingreso
