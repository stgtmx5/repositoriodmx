...
function ConfigurarSistema(){
	...
	//NOMBRE DE BROWSER PARA BARRA DE HERRAMIENTAS
	Catalogos.ProductosQBNames="qProductosXLinea,QMateriasPrimasXLinea,QRecetasXLinea";
	DMCatalogos.FingerPrintMethod="RegistrarHuellaDigital";	
	
	//Configuracion.SetaApplicationName("Deminus","Déminus ERA"); Original
	
	Configuracion.SetaApplicationName("Deminus","Déminus 2014");
...
//INGRESO MESERO
	DMCatalogos.ModoIngresoMesero=ModoIngresoMesero();	
//APLICATION VARS	
...
//Método de cálculo de porcentajes
	...
	LBVenta.MetodoPorcentaje=AppVars.FXCA021; //faltaba 21/01/2010
...
function ModoProduccion(){
	return Configuracion.eLocalVars.FXCT200;
}
function ModoIngresoMesero(){
	return Configuracion.eLocalVars.FXCT205;
}
...
function AbrirPanelControl_OLD()
{
	/*if(Configuracion.ShowConfigDialog())
		ActualizarConfiguracionSistema();	
	*/
...
Frm=Application.AXForms.AXForm("PanelControl");
	if (Frm==null){
		...
		ButtonMenu=Frm.GetAXObject();			
		ButtonMenu.CreateTitle ("Configuración general");				
		ButtonMenu.CreateButton ("1", "Diseño de la página de inicio",Application.LoadImage(eBasic.AddSlashPath(Application.GetPath(0))+"icons\\miempresa.jpg",false));
		ButtonMenu.CreateButton ("2", "Opciones",Application.LoadImage(eBasic.AddSlashPath(Application.GetPath(0))+"icons\\opciones.jpg",false));
		ButtonMenu.CreateButton ("3", "Herramientas",Application.LoadImage(eBasic.AddSlashPath(Application.GetPath(0))+"icons\\herramientas.jpg",false));		
		ButtonMenu.CreateButton ("4", "Módulos instalados",Application.LoadImage(eBasic.AddSlashPath(Application.GetPath(0))+"icons\\modulos.jpg",false));
		ButtonMenu.CreateButton ("5", "Carga inicial de programas",Application.LoadImage(eBasic.AddSlashPath(Application.GetPath(0))+"icons\\cargainicial.jpg",false));
				
		ButtonMenu.CreateTitle ("Configuración de Comprobantes Fiscales");
		if(gFunciones.CFDActivo() && Configuracion.FECompleta) ButtonMenu.CreateButton ("16", "Asistente de configuración",Application.LoadImage(eBasic.AddSlashPath(Application.GetPath(0))+"icons\\Wizard64.bmp",false));
		if(gFunciones.CFDActivo() && Configuracion.FECompleta) ButtonMenu.CreateButton ("13", "Facturación Electrónica",Application.LoadImage(eBasic.AddSlashPath(Application.GetPath(0))+"icons\\configCFD.bmp",false));
		if(gFunciones.CFDActivo()) ButtonMenu.CreateButton ("15", "Facturación con CBB",Application.LoadImage(eBasic.AddSlashPath(Application.GetPath(0))+"icons\\configCBB.bmp",false));
		if(gFunciones.CFDActivo()) ButtonMenu.CreateButton ("14", "Diseñador de plantillas",Application.LoadImage(eBasic.AddSlashPath(Application.GetPath(0))+"icons\\generico.jpg",false));
		
		ButtonMenu.CreateTitle ("Seguridad de la aplicación");
		ButtonMenu.CreateButton ("6", "Usuarios",Application.LoadImage(eBasic.AddSlashPath(Application.GetPath(0))+"icons\\user.jpg",false));
		ButtonMenu.CreateButton ("7", "Grupos de usuarios",Application.LoadImage(eBasic.AddSlashPath(Application.GetPath(0))+"icons\\grupos2.jpg",false));
		ButtonMenu.CreateButton ("8", "Permisos de reporte",Application.LoadImage(eBasic.AddSlashPath(Application.GetPath(0))+"icons\\permisos.jpg",false));
		
		ButtonMenu.CreateTitle ("Kit de Desarrollo de Software (SDK)");
		ButtonMenu.CreateButton ("9", "Formularios",Application.LoadImage(eBasic.AddSlashPath(Application.GetPath(0))+"icons\\forms3.jpg",false));
		ButtonMenu.CreateButton ("10", "Programas",Application.LoadImage(eBasic.AddSlashPath(Application.GetPath(0))+"icons\\programas.jpg",false));
		ButtonMenu.CreateButton ("11", "Reportes",Application.LoadImage(eBasic.AddSlashPath(Application.GetPath(0))+"icons\\reportes.jpg",false));
		ButtonMenu.CreateButton ("12", "Consola de comandos",Application.LoadImage(eBasic.AddSlashPath(Application.GetPath(0))+"icons\\consola.jpg",false));
		ButtonMenu.Draw();
		Application.MouseDefault();
		}
		else
