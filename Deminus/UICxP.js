...
//NOTA IMPORTANTE: No agregar punto y coma la final de las consultas que no lo tienen.
...
if (Brw==null)
	{
		...
		Brw.SetCaptionByFieldName("Codigo_postal","Codigo postal");
		Brw.SetCaptionByFieldName("TipoProveedor","Tipo de proveedor");
		
		Brw.DetailFunction="UICxP.Detail";   //25-01-2010
