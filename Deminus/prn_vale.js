function ImprimirVale(PK,Titulo,ErrDesc){
	...
	sql="SELECT MovCaja.Cheques, MovCaja.Depositos, MovCaja.Efectivo, MovCaja.Fecha, MovCaja.Hora, MovCaja.Notas, MovCaja.Referencia, MovCaja.Tarjetas, MovCaja.Vales, Divisa.Codigo AS CodigoDivisa, Divisa.Descripcion AS DescDivisa, Categoria.Descripcion AS DescCategoria FROM Categoria INNER JOIN (Divisa INNER JOIN MovCaja ON Divisa.Sys_PK = MovCaja.IDivisa) ON Categoria.Sys_PK = MovCaja.ICategoria WHERE MovCaja.Sys_PK="+PK;
