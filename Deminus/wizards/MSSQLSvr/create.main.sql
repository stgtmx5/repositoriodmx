CREATE TABLE Agente (Sys_PK Int  NOT NULL IDENTITY(1,1) CONSTRAINT IDX_Agente_PK PRIMARY KEY , Sys_TimeStamp Datetime  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL , Sys_DTCreated Datetime , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported Bit , Sys_DTExported Datetime , Sys_Info VARCHAR(32), Codigo VARCHAR(10) NOT NULL , CodNomina VARCHAR(50), eMail VARCHAR(50), Nombre VARCHAR(50) NOT NULL  UNIQUE , Notas VARCHAR(MAX) , PComision float , Telefono VARCHAR(150), Domicilio1 Int, UF_capitan Bit, Uf_Sys_Baja Bit,sys_recver int default 0,sys_deleted bit null,sys_lock int null );
CREATE TABLE Almacen (Sys_PK Int  NOT NULL IDENTITY(1,1) CONSTRAINT IDX_Almacen_PK PRIMARY KEY , Sys_TimeStamp Datetime  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL , Sys_DTCreated Datetime , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported Bit , Sys_DTExported Datetime , Sys_Info VARCHAR(32), CodCuenta VARCHAR(50), Codigo VARCHAR(10) NOT NULL , Descripcion VARCHAR(50) NOT NULL  UNIQUE , eMail VARCHAR(50), Fax VARCHAR(150), Telefonos VARCHAR(150), WebSite VARCHAR(150), Domicilio1 Int,sys_recver int default 0,sys_deleted bit null,sys_lock int null );
...
CREATE TABLE Banco (Sys_PK Int  NOT NULL IDENTITY(1,1) CONSTRAINT IDX_Banco_PK PRIMARY KEY , Sys_TimeStamp Datetime  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL , Sys_DTCreated Datetime , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported Bit , Sys_DTExported Datetime , Sys_Info VARCHAR(32), Nombre VARCHAR(50) NOT NULL , Notas VARCHAR(MAX) , WebSite VARCHAR(150), Contacto Int,sys_recver int default 0,sys_deleted bit null,sys_lock int null );
CREATE TABLE BlockDocumentos (Sys_PK Int  NOT NULL IDENTITY(1,1) CONSTRAINT IDX_BlockDocumentos_PK PRIMARY KEY , Sys_TimeStamp Datetime  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL , Sys_DTCreated Datetime , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported Bit , Sys_DTExported Datetime , Sys_Info VARCHAR(32), Activo Bit  NOT NULL , Datos VARCHAR(255), Documento Int  NOT NULL , FInicial Int  NOT NULL , Fiscal Bit  NOT NULL , FUltimo Int  NOT NULL , IDControl VARCHAR(32), NumControl Int , Serie VARCHAR(10) NOT NULL,sys_recver int default 0,sys_deleted bit null,sys_lock int null );
CREATE TABLE Caja (Sys_PK Int  NOT NULL IDENTITY(1,1) CONSTRAINT IDX_Caja_PK PRIMARY KEY , Sys_TimeStamp Datetime  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL , Sys_DTCreated Datetime , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported Bit , Sys_DTExported Datetime , Sys_Info VARCHAR(32), CodCuenta VARCHAR(50), Codigo VARCHAR(5) NOT NULL , Descripcion VARCHAR(50) UNIQUE , Notas VARCHAR(MAX) , CentroConsumo Int  NOT NULL,sys_recver int default 0,sys_deleted bit null,sys_lock int null );
CREATE TABLE Cajero (Sys_PK Int  NOT NULL IDENTITY(1,1) CONSTRAINT IDX_Cajero_PK PRIMARY KEY , Sys_TimeStamp Datetime  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL , Sys_DTCreated Datetime , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported Bit , Sys_DTExported Datetime , Sys_Info VARCHAR(32), Codigo VARCHAR(10) NOT NULL , CodNomina VARCHAR(50), Contrasena VARCHAR(32) NOT NULL , eMail VARCHAR(50), Nombre VARCHAR(50) NOT NULL  UNIQUE , Notas VARCHAR(MAX) , Telefono VARCHAR(150), Domicilio1 Int, Uf_Sys_Baja Bit,sys_recver int default 0,sys_deleted bit null,sys_lock int null );
...
CREATE TABLE Guia (Sys_PK Int  NOT NULL IDENTITY(1,1) CONSTRAINT IDX_Guia_PK PRIMARY KEY , Sys_TimeStamp Datetime  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL , Sys_DTCreated Datetime , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported Bit , Sys_DTExported Datetime , Sys_Info VARCHAR(32), Alto float , Ancho float , Costo money , Deducible money , Dias Int , EnAtencion VARCHAR(50), Estado Int  NOT NULL , FCompra Datetime , FEmbarque Datetime , FEntrega Datetime , Largo float , Notas VARCHAR(MAX) , Numero VARCHAR(50) NOT NULL , Peso float , SumaAsegurada money , IDivisa Int , IDomicilio Int  NOT NULL , IPorteador Int  NOT NULL , IRepartidor Int,sys_recver int default 0,sys_deleted bit null,sys_lock int null );
...
CREATE TABLE IVariable (Sys_PK Int  NOT NULL IDENTITY(1,1) CONSTRAINT IDX_IVariable_PK PRIMARY KEY , Sys_TimeStamp Datetime  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL , Sys_DTCreated Datetime , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported Bit , Sys_DTExported Datetime , Sys_Info VARCHAR(32), CDirectoProm money , CIndirectoProm money , CManoObraProm money , CMaquinariaProm money , Descripcion VARCHAR(35), Factor float , Maximo float , Minimo float , PAdicional Int , Grupo Int , FK_Producto_IVariables Int  NOT NULL,sys_recver int default 0,sys_deleted bit null,sys_lock int null );
CREATE TABLE Linea (Sys_PK Int  NOT NULL IDENTITY(1,1) CONSTRAINT IDX_Linea_PK PRIMARY KEY , Sys_TimeStamp Datetime  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL , Sys_DTCreated Datetime , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported Bit , Sys_DTExported Datetime , Sys_Info VARCHAR(32), Clase Int  NOT NULL , Codigo VARCHAR(15) NOT NULL , Color Int , Comision1 float , Comision2 float , Comision3 float , Comision4 float , Comision5 float , Descripcion VARCHAR(50) NOT NULL  UNIQUE , Notas VARCHAR(MAX) , Visible Bit,Uf_indicaciones VARCHAR(MAX),sys_recver int default 0,sys_deleted bit null,sys_lock int null);
CREATE TABLE Lote (Sys_PK Int  NOT NULL IDENTITY(1,1) CONSTRAINT IDX_Lote_PK PRIMARY KEY , Sys_TimeStamp Datetime  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL , Sys_DTCreated Datetime , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported Bit , Sys_DTExported Datetime , Sys_Info VARCHAR(32), Entradas float , Existencia float , FCaducidad Datetime , FEntrada Datetime , Numero VARCHAR(50) NOT NULL , IProducto Int  NOT NULL,sys_recver int default 0,sys_deleted bit null,sys_lock int null );
CREATE TABLE Marca (Sys_PK Int  NOT NULL IDENTITY(1,1) CONSTRAINT IDX_Marca_PK PRIMARY KEY , Sys_TimeStamp Datetime  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL , Sys_DTCreated Datetime , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported Bit , Sys_DTExported Datetime , Sys_Info VARCHAR(32), Codigo VARCHAR(5) NOT NULL , Descripcion VARCHAR(50) NOT NULL  UNIQUE,sys_recver int default 0,sys_deleted bit null,sys_lock int null );
...
CREATE TABLE Pais (Sys_PK Int  NOT NULL IDENTITY(1,1) CONSTRAINT IDX_Pais_PK PRIMARY KEY , Sys_TimeStamp Datetime  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL , Sys_DTCreated Datetime , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported Bit , Sys_DTExported Datetime , Sys_Info VARCHAR(32), Codigo VARCHAR(8) NOT NULL , CodigoTel VARCHAR(5), Nombre VARCHAR(50) NOT NULL,sys_recver int default 0,sys_deleted bit null,sys_lock int null );
CREATE TABLE Porteador (Sys_PK Int  NOT NULL IDENTITY(1,1) CONSTRAINT IDX_Porteador_PK PRIMARY KEY , Sys_TimeStamp Datetime  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL , Sys_DTCreated Datetime , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported Bit , Sys_DTExported Datetime , Sys_Info VARCHAR(32), Codigo VARCHAR(5) NOT NULL , Descripcion VARCHAR(50) NOT NULL  UNIQUE , Notas VARCHAR(MAX) , IProveedor Int,sys_recver int default 0,sys_deleted bit null,sys_lock int null );
...
CREATE TABLE cImpAdicionales (ID Int  NOT NULL CONSTRAINT IDX_cImpAdicionales_PK PRIMARY KEY , Const VARCHAR(255));
...
CREATE TABLE dmnsMesa (Sys_PK Int  NOT NULL IDENTITY(1,1) CONSTRAINT IDX_dmnsMesa_PK PRIMARY KEY , Sys_TimeStamp Datetime  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL , Sys_DTCreated Datetime , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported Bit , Sys_DTExported Datetime , Sys_Info VARCHAR(32), Bandera Int , H Int , ID VARCHAR(10) NOT NULL , Mesero VARCHAR(32), Notas VARCHAR(MAX) , Personas Int , W Int , X Int , Y Int , IZona Int  NOT NULL,sys_recver int default 0,sys_deleted bit null,sys_lock int null );
CREATE TABLE dmnsZona (Sys_PK Int  NOT NULL IDENTITY(1,1) CONSTRAINT IDX_dmnsZona_PK PRIMARY KEY , Sys_TimeStamp Datetime  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL , Sys_DTCreated Datetime , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported Bit , Sys_DTExported Datetime , Sys_Info VARCHAR(32), Archivo VARCHAR(255), Color Int , Fumar Bit , ID VARCHAR(35) NOT NULL , Mesero VARCHAR(32), Notas VARCHAR(MAX),sys_recver int default 0,sys_deleted bit null,sys_lock int null );
CREATE TABLE dmnsBarra (Sys_PK Int  NOT NULL IDENTITY(1,1) CONSTRAINT IDX_dmnsBarra_PK PRIMARY KEY, Nombre VARCHAR(50),Tipo Int,Opciones VARCHAR(MAX));
CREATE TABLE dmnsAsignBarra (Sys_PK Int  NOT NULL IDENTITY(1,1) CONSTRAINT IDX_dmnsAsignBarra_PK PRIMARY KEY, Tipo Int, FK Int, FKBarra Int, Auto Int);
CREATE TABLE dmnsPWDAgente (Sys_PK Int  NOT NULL IDENTITY(1,1) CONSTRAINT IDX_dmnsPWDAgente_PK PRIMARY KEY,FKAgente Int, PWD VARCHAR(50), Cadena VARCHAR(255), Img Binary);
CREATE TABLE ut_DmCancel (Sys_PK Int  NOT NULL IDENTITY(1,1) CONSTRAINT IDX_ut_Cancelaciones_PK PRIMARY KEY ,  Detalle VARCHAR(MAX) , Fecha Int , Hora Int , IOrden Int , IVenta Int , Notas VARCHAR(MAX) , Usuario VARCHAR(50));
...
CREATE UNIQUE INDEX indexAgente_Sys_GUID ON Agente(Sys_GUID); 
CREATE UNIQUE INDEX indexAgente_Codigo ON Agente(Codigo); 

CREATE UNIQUE INDEX indexAlmacen_Sys_GUID ON Almacen(Sys_GUID); 
CREATE UNIQUE INDEX indexAlmacen_Codigo ON Almacen(Codigo); 

CREATE UNIQUE INDEX indexAplCxC_Sys_GUID ON AplCxC(Sys_GUID); 

CREATE UNIQUE INDEX indexAplCxP_Sys_GUID ON AplCxP(Sys_GUID); 

CREATE UNIQUE INDEX indexBanco_Sys_GUID ON Banco(Sys_GUID); 
CREATE UNIQUE INDEX indexBanco_Nombre ON Banco(Nombre); 

CREATE UNIQUE INDEX indexBlockDocumentos_Sys_GUID ON BlockDocumentos(Sys_GUID); 

CREATE UNIQUE INDEX indexCaja_Sys_GUID ON Caja(Sys_GUID); 
CREATE UNIQUE INDEX indexCaja_Codigo ON Caja(Codigo); 

CREATE UNIQUE INDEX indexCajero_Sys_GUID ON Cajero(Sys_GUID); 
CREATE UNIQUE INDEX indexCajero_Codigo ON Cajero(Codigo); 

CREATE UNIQUE INDEX indexCardex_Sys_GUID ON Cardex(Sys_GUID); 
CREATE UNIQUE INDEX indexCardex_Referencia ON Cardex(Referencia); 

CREATE UNIQUE INDEX indexCategoria_Sys_GUID ON Categoria(Sys_GUID); 
CREATE UNIQUE INDEX indexCategoria_Codigo ON Categoria(Codigo);

CREATE UNIQUE INDEX indexCConsumo_Sys_GUID ON CConsumo(Sys_GUID); 
CREATE UNIQUE INDEX indexCConsumo_Codigo ON CConsumo(Codigo); 

CREATE UNIQUE INDEX indexcfgImpuesto_Sys_GUID ON cfgImpuesto(Sys_GUID); 
CREATE UNIQUE INDEX indexcfgImpuesto_Nombre ON cfgImpuesto(Nombre); 

CREATE UNIQUE INDEX indexChequera_Sys_GUID ON Chequera(Sys_GUID); 
CREATE UNIQUE INDEX indexChequera_Nombre ON Chequera(Nombre); 

CREATE UNIQUE INDEX indexCiudad_Sys_GUID ON Ciudad(Sys_GUID); 
CREATE UNIQUE INDEX indexCiudad_Codigo ON Ciudad(Codigo); 

CREATE UNIQUE INDEX indexCliente_Sys_GUID ON Cliente(Sys_GUID); 
CREATE UNIQUE INDEX indexCliente_Codigo ON Cliente(Codigo); 

CREATE UNIQUE INDEX indexCLoteXAlmacen_Sys_GUID ON CLoteXAlmacen(Sys_GUID); 

CREATE UNIQUE INDEX indexCompra_Sys_GUID ON Compra(Sys_GUID); 

CREATE UNIQUE INDEX indexContacto_Sys_GUID ON Contacto(Sys_GUID); 

CREATE UNIQUE INDEX indexCorte_Sys_GUID ON Corte(Sys_GUID); 

CREATE UNIQUE INDEX indexCProduccion_Sys_GUID ON CProduccion(Sys_GUID);
CREATE UNIQUE INDEX indexCProduccion_Codigo ON CProduccion(Codigo);

CREATE UNIQUE INDEX indexCupon_Sys_GUID ON Cupon(Sys_GUID);
CREATE UNIQUE INDEX indexCupon_Codigo ON Cupon(Codigo);

CREATE UNIQUE INDEX indexDAdic2_Sys_GUID ON DAdic2(Sys_GUID);
ALTER TABLE DAdic2 ALTER COLUMN IProducto INT NOT NULL;

CREATE UNIQUE INDEX indexDAdicionales_Sys_GUID ON DAdicionales(Sys_GUID);
CREATE UNIQUE INDEX indexDCantidades_Sys_GUID ON DCantidades(Sys_GUID);
CREATE UNIQUE INDEX indexDCapa_Sys_GUID ON DCapa(Sys_GUID);
CREATE UNIQUE INDEX indexDCardex_Sys_GUID ON DCardex(Sys_GUID);
CREATE UNIQUE INDEX indexDCheques_Sys_GUID ON DCheques(Sys_GUID);
CREATE UNIQUE INDEX indexDCompra_Sys_GUID ON DCompra(Sys_GUID);
CREATE UNIQUE INDEX indexDCxC_Sys_GUID ON DCxC(Sys_GUID);
CREATE UNIQUE INDEX indexDCxP_Sys_GUID ON DCxP(Sys_GUID);
CREATE UNIQUE INDEX indexDDepositos_Sys_GUID ON DDepositos(Sys_GUID);

CREATE UNIQUE INDEX indexDepartamento_Sys_GUID ON Departamento(Sys_GUID);
CREATE UNIQUE INDEX indexDepartamento_Codigo ON Departamento(Codigo);

CREATE UNIQUE INDEX indexDivisa_Sys_GUID ON Divisa(Sys_GUID);
CREATE UNIQUE INDEX indexDivisa_Codigo ON Divisa(Codigo);

CREATE UNIQUE INDEX indexDomicilio_Sys_GUID ON Domicilio(Sys_GUID);
CREATE UNIQUE INDEX indexDOrden_Sys_GUID ON DOrden(Sys_GUID);
CREATE UNIQUE INDEX indexDTabla_Sys_GUID ON DTabla(Sys_GUID);
CREATE UNIQUE INDEX indexDTarjeta_Sys_GUID ON DTarjeta(Sys_GUID);
CREATE UNIQUE INDEX indexDVales_Sys_GUID ON DVales(Sys_GUID);
CREATE UNIQUE INDEX indexDVenta_Sys_GUID ON DVenta(Sys_GUID);

CREATE UNIQUE INDEX indexEdoProv_Sys_GUID ON EdoProv(Sys_GUID);
CREATE UNIQUE INDEX indexEdoProv_Codigo ON EdoProv(Codigo);

CREATE UNIQUE INDEX indexExistencias_Sys_GUID ON Existencias(Sys_GUID);
CREATE UNIQUE INDEX indexFoliosDocumentos_Sys_GUID ON FoliosDocumentos(Sys_GUID);

CREATE UNIQUE INDEX indexGrupoClientes_Sys_GUID ON GrupoClientes(Sys_GUID);
CREATE UNIQUE INDEX indexGrupoClientes_Nombre ON GrupoClientes(Nombre);

CREATE UNIQUE INDEX indexGrupoProductos_Sys_GUID ON GrupoProductos(Sys_GUID);
CREATE UNIQUE INDEX indexGrupoProductos_Nombre ON GrupoProductos(Nombre);

CREATE UNIQUE INDEX indexGrupoProveedores_Sys_GUID ON GrupoProveedores(Sys_GUID);
CREATE UNIQUE INDEX indexGrupoProveedores_Nombre ON GrupoProveedores(Nombre);

CREATE UNIQUE INDEX indexGuia_Sys_GUID ON Guia(Sys_GUID);
CREATE UNIQUE INDEX indexGuia_Numero ON Guia(Numero);

CREATE UNIQUE INDEX indexIEnsamble_Sys_GUID ON IEnsamble(Sys_GUID);
CREATE UNIQUE INDEX indexIVariable_Sys_GUID ON IVariable(Sys_GUID);

CREATE UNIQUE INDEX indexLinea_Sys_GUID ON Linea(Sys_GUID);
CREATE UNIQUE INDEX indexLinea_Codigo ON Linea(Codigo);

CREATE UNIQUE INDEX indexLote_Sys_GUID ON Lote(Sys_GUID);
CREATE UNIQUE INDEX indexLote_Numero ON Lote(Numero);

CREATE UNIQUE INDEX indexMarca_Sys_GUID ON Marca(Sys_GUID);
CREATE UNIQUE INDEX indexMarca_Codigo ON Marca(Codigo);

CREATE UNIQUE INDEX indexMonedero_Sys_GUID ON Monedero(Sys_GUID);
CREATE UNIQUE INDEX indexMovCaja_Sys_GUID ON MovCaja(Sys_GUID);

CREATE UNIQUE INDEX indexMovCuenta_Sys_GUID ON MovCuenta(Sys_GUID);
CREATE UNIQUE INDEX indexMovCuenta_Referencia ON MovCuenta(Referencia);

CREATE UNIQUE INDEX indexOrden_Sys_GUID ON Orden(Sys_GUID);
CREATE UNIQUE INDEX indexOrden_Referencia ON Orden(Referencia);

CREATE UNIQUE INDEX indexPais_Sys_GUID ON Pais(Sys_GUID);
CREATE UNIQUE INDEX indexPais_Nombre ON Pais(Nombre);

CREATE UNIQUE INDEX indexPorteador_Sys_GUID ON Porteador(Sys_GUID);
CREATE UNIQUE INDEX indexPorteador_Codigo ON Porteador(Codigo);

CREATE UNIQUE INDEX indexPrecioVenta_Sys_GUID ON PrecioVenta(Sys_GUID);

CREATE UNIQUE INDEX indexProducto_Sys_GUID ON Producto(Sys_GUID);
CREATE UNIQUE INDEX indexProducto_Codigo ON Producto(Codigo);

ALTER TABLE Producto ADD IVariables INT;

CREATE UNIQUE INDEX indexPromocion_Sys_GUID ON Promocion(Sys_GUID);
CREATE UNIQUE INDEX indexPromocion_Codigo ON Promocion(Codigo);
CREATE UNIQUE INDEX indexPromocion_Nombre ON Promocion(Nombre);

CREATE UNIQUE INDEX indexProveedor_Sys_GUID ON Proveedor(Sys_GUID);
CREATE UNIQUE INDEX indexProveedor_Codigo ON Proveedor(Codigo);

CREATE UNIQUE INDEX indexRepartidor_Sys_GUID ON Repartidor(Sys_GUID);
CREATE UNIQUE INDEX indexRepartidor_Codigo ON Repartidor(Codigo);
CREATE UNIQUE INDEX indexRepartidor_Nombre ON Repartidor(Nombre);

CREATE UNIQUE INDEX indexSerie_Sys_GUID ON Serie(Sys_GUID);
CREATE UNIQUE INDEX indexSerie_Numero ON Serie(Numero);

CREATE UNIQUE INDEX indexTabla_Sys_GUID ON Tabla(Sys_GUID);
CREATE UNIQUE INDEX indexTabla_Nombre ON Tabla(Nombre);

CREATE UNIQUE INDEX indexTarjetaCredito_Sys_GUID ON TarjetaCredito(Sys_GUID);
CREATE UNIQUE INDEX indexTarjetaCredito_Codigo ON TarjetaCredito(Codigo);

CREATE UNIQUE INDEX indexTasaFija_Sys_GUID ON TasaFija(Sys_GUID);
CREATE UNIQUE INDEX indexTasaFija_Nombre ON TasaFija(Nombre);

CREATE UNIQUE INDEX indexTasaVariable_Sys_GUID ON TasaVariable(Sys_GUID);
CREATE UNIQUE INDEX indexTasaVariable_Nombre ON TasaVariable(Nombre);

CREATE UNIQUE INDEX indexTipoCliente_Sys_GUID ON TipoCliente(Sys_GUID);
CREATE UNIQUE INDEX indexTipoCliente_Codigo ON TipoCliente(Codigo);

CREATE UNIQUE INDEX indexTipoCupon_Sys_GUID ON TipoCupon(Sys_GUID);
CREATE UNIQUE INDEX indexTipoCupon_Nombre ON TipoCupon(Nombre);

CREATE UNIQUE INDEX indexTipoProveedor_Sys_GUID ON TipoProveedor(Sys_GUID);
CREATE UNIQUE INDEX indexTipoProveedor_Codigo ON TipoProveedor(Codigo);

CREATE UNIQUE INDEX indexVenta_Sys_GUID ON Venta(Sys_GUID);
CREATE UNIQUE INDEX indexVenta_Referencia ON Venta(Referencia);

CREATE UNIQUE INDEX indexZona_Sys_GUID ON Zona(Sys_GUID);
CREATE UNIQUE INDEX indexZona_Nombre ON Zona(Nombre);

CREATE UNIQUE INDEX indexdmnsMesa_Sys_GUID ON dmnsMesa(Sys_GUID);
CREATE UNIQUE INDEX indexdmnsZona_Sys_GUID ON dmnsZona(Sys_GUID);

CREATE UNIQUE INDEX indexMovCaja_CEFNRTV ON MovCaja(Cheques,Efectivo,Fecha,Notas,Referencia,Tarjetas,Vales);
...
CREATE PROCEDURE NullCContableAplicado AS BEGIN UPDATE CContable SET ICuenta=NULL, Contrapartida=NULL; END
 ...
 CREATE PROCEDURE qryProductosLikeII (@P VARCHAR(255), @Q VARCHAR(255), @R VARCHAR(255), @S VARCHAR(255), @T VARCHAR(255), @A INT) AS  BEGIN SELECT Producto.Sys_PK, Producto.Codigo, Producto.Descripcion, Producto.CodBar1, Producto.CodBar2, Producto.CodBar3, Producto.Precio1, Producto.Precio2, Producto.Precio3, Producto.Precio4, Producto.Precio5, Existencias.Existencia FROM Producto LEFT JOIN Existencias ON Producto.Sys_PK=Existencias.FK_Producto_IExistencias WHERE Producto.Visible<>0 And (Producto.Codigo Like @P Or Producto.CodBar1 Like @Q Or Producto.CodBar2 Like @R Or Producto.CodBar3 Like @S Or Producto.Descripcion Like @T) And (Existencias.IAlmacen=@A OR (Existencias.IAlmacen is null)) ORDER BY Producto.Descripcion; END
...
CREATE VIEW qProdDmns AS SELECT TOP 100 PERCENT Producto.Sys_PK, Producto.Descripcion, Producto.Precio1, Producto.Precio2, Producto.Precio3, Producto.Precio4, Producto.Precio5, Producto.Color, Producto.Data1, Producto.VincularData, Producto.IClase, Producto.ITipo, Producto.ILinea, Producto.IDivisa, Divisa.TCambio, cfgImpuesto.I1Venta, cfgImpuesto.I2Venta, cfgImpuesto.I3Venta, cfgImpuesto.I4Venta, cfgImpuesto.Nombre, isnull(qPartidasVariables.Partidas,0) AS Variables, Producto.Lim2, Producto.Lim3, Producto.Lim4, Producto.Lim5, Producto.flagLimites,Producto.Unidad,Producto.FactorB FROM (cfgImpuesto INNER JOIN (Divisa INNER JOIN Producto ON Divisa.Sys_PK=Producto.IDivisa) ON cfgImpuesto.Sys_PK=Producto.Impuestos) LEFT JOIN qPartidasVariables ON Producto.Sys_PK=qPartidasVariables.PKProducto WHERE Producto.Visible<>0 ORDER BY Producto.Descripcion;

CREATE VIEW qProdDmns2 AS SELECT TOP 100 PERCENT Producto.Sys_PK, Producto.Descripcion, Producto.Adicional, Producto.PAdic1, Producto.PAdic2, Producto.PAdic3, Producto.PAdic4, Producto.PAdic5, Producto.Color, Producto.IClase, Producto.ITipo, Producto.ILinea, Producto.IDivisa, Divisa.TCambio, cfgImpuesto.I1Venta, cfgImpuesto.I2Venta, cfgImpuesto.I3Venta, cfgImpuesto.I4Venta, cfgImpuesto.Nombre, isnull(qPartidasVariables.Partidas,0) AS Variables FROM ((Producto INNER JOIN cfgImpuesto ON cfgImpuesto.Sys_PK=Producto.Impuestos) INNER JOIN Divisa ON Divisa.Sys_PK=Producto.IDivisa) LEFT JOIN qPartidasVariables ON Producto.Sys_PK=qPartidasVariables.PKProducto ORDER BY Producto.Descripcion;
...
CREATE VIEW qVentasServicioMesa AS SELECT Venta.*,((Venta.Subtotal-Venta.Descuento1-Venta.Descuento2)+Venta.Impuesto1+Venta.Impuesto2+Venta.Impuesto3+Venta.Impuesto4) AS Total FROM Venta WHERE (Venta.StatusAdministrativo=1 OR Venta.StatusAdministrativo=2) AND Venta.dmnsMesa<>'' AND (isnull(Venta.dmnsMesa,'')<>'');
...
CREATE VIEW qVentasOrdenPendienteDmns AS SELECT DISTINCT TOP 100 PERCENT Venta.Sys_PK,Venta.Fecha, Venta.Referencia, Venta.ICliente, Cliente.Nombre AS NombreCliente FROM Cliente INNER JOIN (Venta INNER JOIN Orden ON Venta.Sys_PK=Orden.IVenta) ON Venta.ICliente=Cliente.Sys_PK WHERE (Orden.Status<>3 AND Orden.Status<>4) ORDER BY Venta.Fecha,Venta.Referencia;

CREATE PROCEDURE UpdLockSale(@Machine Varchar(32),@PKVenta INT) AS BEGIN UPDATE Venta SET Sys_Info = @Machine WHERE ((isnull(Sys_Info,'')='') Or Sys_Info=@Machine) And (StatusAdministrativo=1 Or StatusAdministrativo=2 Or StatusAdministrativo=4 Or StatusAdministrativo=5) And Sys_PK=@PKVenta; END;

CREATE PROCEDURE UpdUnLockSale(@Machine Varchar(32),@PKVenta INT) AS BEGIN UPDATE Venta SET Sys_Info = Null WHERE Sys_Info=@Machine And (StatusAdministrativo=1 Or StatusAdministrativo=2 Or StatusAdministrativo=4 Or StatusAdministrativo=5) And Sys_PK=@PKVenta; END;
...
INSERT INTO ut_autoload (Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info,uf_Archivo, uf_Orden) VALUES ('2009-11-11 11:54:20','9F7FC44F2C2440BD82C892148F8C7615','2009-11-11 11:54:20',NULL,NULL,0,'2009-11-11 11:54:20',NULL,'UIDef.js',1);

INSERT INTO ut_autoload (Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info,uf_Archivo, uf_Orden) VALUES('2009-11-11 11:54:20','C54B8530A44F421BAED496E06B00CD00','2009-11-11 11:54:20',NULL,NULL,0,'2009-11-11 11:54:20',NULL,'UIMiEmpresa.js',2);

INSERT INTO ut_autoload (Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info,uf_Archivo, uf_Orden) VALUES('2009-11-11 11:54:20','F57C1336F60146C9A7FA55B0CEEF047F','2009-11-11 11:54:20',NULL,NULL,0,'2009-11-11 11:54:20',NULL,'UIFinanzas.js',3);

INSERT INTO ut_autoload (Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info,uf_Archivo, uf_Orden) VALUES('2009-11-11 11:54:20','2C44548C3C414E49AFAA3BAFF96BDFC7','2009-11-11 11:54:20',NULL,NULL,0,'2009-11-11 11:54:20',NULL,'UIVentas.js',4);

INSERT INTO ut_autoload (Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info,uf_Archivo, uf_Orden) VALUES('2009-11-11 11:54:20','CC5B9C24524247B18E7739A8C06CFECE','2009-11-11 11:54:20',NULL,NULL,0,'2009-11-11 11:54:20',NULL,'UICxC.js',5);

INSERT INTO ut_autoload (Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info,uf_Archivo, uf_Orden) VALUES('2009-11-11 11:54:20','36D9180E388A446DA4E4E20100AF1D56','2009-11-11 11:54:20',NULL,NULL,0,'2009-11-11 11:54:20',NULL,'UIInventario.js',6);

INSERT INTO ut_autoload (Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info,uf_Archivo, uf_Orden) VALUES('2009-11-11 11:54:20','B51811AF6110446A9451C8EB84D57147','2009-11-11 11:54:20',NULL,NULL,0,'2009-11-11 11:54:20',NULL,'UICompras.js',7);

INSERT INTO ut_autoload (Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info,uf_Archivo, uf_Orden) VALUES('2009-11-11 11:54:20','B08988420CAA4A7AAB590154BB9CFEE7','2009-11-11 11:54:20',NULL,NULL,0,'2009-11-11 11:54:20',NULL,'UICxP.js',8);

INSERT INTO ut_autoload (Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info,uf_Archivo, uf_Orden) VALUES('2009-11-11 11:54:20','97E3D6FD698F4C409B1487A82E20B237','2009-11-11 11:54:20',NULL,NULL,0,'2009-11-11 11:54:20',NULL,'FXConfig.js',9);

INSERT INTO ut_autoload (Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info,uf_Archivo, uf_Orden) VALUES('2009-11-11 11:54:20','356D2AEF853B408CB6334E468D00878D','2009-11-11 11:54:20',NULL,NULL,0,'2009-11-11 11:54:20',NULL,'Reportes.js',10);

INSERT INTO ut_autoload (Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info,uf_Archivo, uf_Orden) VALUES('2009-11-11 11:54:20','30A1AA2B39E3481AAD95451300450018','2009-11-11 11:54:20',NULL,NULL,0,'2009-11-11 11:54:20',NULL,'Poliza.js',11);

INSERT INTO ut_autoload (Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info,uf_Archivo, uf_Orden) VALUES('2009-11-11 11:54:20','02432BA3B41F4C749F77AA9B841D26B8','2009-11-11 11:54:20',NULL,NULL,0,'2009-11-11 11:54:20',NULL,'Eventos.js',12);

INSERT INTO ut_autoload (Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info,uf_Archivo, uf_Orden) VALUES('2010-11-11 11:54:20','9A1F9EC55D96400B839D82E665A6C07E','2010-11-11 11:54:20',NULL,NULL,0,'2010-11-11 11:54:20',NULL,'Procesos.js',13);

INSERT INTO ut_autoload (Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info,uf_Archivo, uf_Orden) VALUES('2010-11-11 11:54:20','590A09E3620042D49B75BC201957D25C','2010-11-11 11:54:20',NULL,NULL,0,'2010-11-11 11:54:20',NULL,'UIEjercicio.js',14);

INSERT INTO ut_autoload (Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info,uf_Archivo, uf_Orden) VALUES('2010-11-11 11:54:20','26ECEE4B6D75451AA0E9D0BDE4C5F31B','2010-11-11 11:54:20',NULL,NULL,0,'2010-11-11 11:54:20',NULL,'cfd.js',15);

INSERT INTO ut_autoload (Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info,uf_Archivo, uf_Orden) VALUES('2010-11-11 11:54:20','840608E982CA4375AF73A409C100ED5D','2010-11-11 11:54:20',NULL,NULL,0,'2010-11-11 11:54:20',NULL,'cfdi.js',16);

INSERT INTO ut_autoload (Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info,uf_Archivo, uf_Orden) VALUES('2009-11-11 11:54:20','2400D663211C42F6881858D5E0E7DA56','2009-11-11 11:54:20',NULL,NULL,0,'2009-11-11 11:54:20',NULL,'UIGastos.js',17);

INSERT INTO ut_autoload (Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info,uf_Archivo, uf_Orden) VALUES('2009-11-11 11:54:20','22E8A90CE44845F9A3FBBDFB515DCF95','2009-11-11 11:54:20',NULL,NULL,0,'2009-11-11 11:54:20',NULL,'MaxicomercioBI.js',18);



INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','492F4BCA208F45069BFC6F0597CB3351','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,0,'Mi Empresa',NULL,NULL,1,NULL);

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','98A1FABB79F94DF89962FF16C875001F','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Tableros de indicadores','icons\MCBI.jpg','MaxicomercioBI.qTableros()',2,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','057E214C4EE211E3A1FB143DF30D67DC','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Atención a clientes','icons\\atencion.jpg','UICRM.ShowCRM()',3,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','33D974E14EE211E3A1FB143DF30D67DC','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Requisiciones','icons\\requisiciones.jpg','UIRequisiciones.MainRequisiciones()',4,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','B6867ECAF7C34ADFA47D1C7EE8CE9677','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Proveedores','icons\proveedor.jpg','UICxP.QCxP()',5,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','8AA65D998D7342B2003CA951A4ACF74D','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Compras','icons\compras.jpg','UICompras.QCompras()',6,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','28250FA355844AA4BAD288EE29238828','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Materias primas','icons\materiaprima.jpg','UIInventario.QMateriasPrimasXLinea()',7,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','703B918463DF45CF95BFF173F3969315','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Recetas','icons\recetas.jpg','UIInventario.QRecetasXLinea()',8,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','B618D76C138B4B59926DD9B4315B87ED','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Artículos y servicios','icons\inventario.jpg','UIInventario.QProductosXLinea()',9,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','7DF4B74DFEC242BF8C7FB9BBAB2261A0','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Clientes','icons\cliente.jpg','UICxC.QCxC()',10,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','FD5946FDBF3E46A3B439E0E8A0FAC69D','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Ventas','icons\ventas.jpg','UIVentas.QVentas()',11,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','AB9E6363617F4974A6D2F0D577348EA9','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Gastos','icons\credito.jpg','UIGastos.qGastos()',12,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','0A32867E94F049A58C7E3605DDEC08E0','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Promociones','icons\promociones.JPG',' UIVentas.QPromociones()',13,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','3EAEC610B8694EECBE72EE42A52EF1B6','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Cuentas de Cheques','icons\chequera.jpg','UIFinanzas.QAdminCuentasCheques()',14,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','FFA7DB5FE8834395B715E695F0A7375E','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Cuentas Contables','icons\ccontable.jpg','UIFinanzas.qCuentas()',15,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','9C65ECC4CD40409BA464B33C9F52ACEF','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Pólizas','icons\polizas.jpg',' UIFinanzas.QPoliza()',16,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','7ACA8D2B63544CF78BCA30C8344C77E7','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Ejercicios Contables','icons\Archivo.jpg','UIEjercicio.AdministrarEjercicios()',17,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','0253FDA9868446FEA6D3B9A8CCFC8CDA','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Cortes de Caja','icons\cortecaja.jpg','UIFinanzas.QSesionesCaja()',18,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','AE341CBA13BA40788135E49C18472F68','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Facturación Electrónica','icons\Facturacion electronica.jpg','cfd.qCFD()',19,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','46E7E5608B4A4ED591D5F6F84B899E6B','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Panel de Control','icons\panelcontrol.jpg','FXConfig.AbrirPanelControl()',20,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','22879BA30A524EEEB077E73C9879B28C','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,0,'Mis Empleados',NULL,NULL,21,NULL);

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','86795B325905418300F8A2003C050031','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Meseros','icons\mesero1.jpg','DMCatalogos.BrwAgentes()',22,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','CD49D27CE062424DB76300229D2E3599','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Cajeros','icons\cajero.jpg','Catalogos.BrwCajeros()',23,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','B8AA6F3ED50E43F4A34B183F5EEF87AB','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Repartidores','icons\repartidor.jpg','Catalogos.BrwRepartidor()',24,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','95F3FB9AB18E435DACCE9FBD83BCE7ED','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,0,'Mis Catálogos',NULL,NULL,25,NULL);

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','BBC96114F98547CF9825E2AB76F3F05C','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Contactos','icons\Contactos.jpg','Catalogos.BrwContactos()',26,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','2D596575F8434757A605BB00DDC6EA62','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Centros de producción y consumo','icons\centro de consumo.jpg','DMCatalogos.dlgCProduccionCConsumo()',27,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','4E332AF9D3E14FC5B9CD87A794195728','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Almacenes','icons\almacen.jpg','UIInventario.CatalogoAlmacenes()',28,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','1BF187E6D3ED456AA5190055EE831848','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Líneas de materias primas','icons\lineamateriasprimas.jpg','DMCatalogos.BrwLineas(1)',29,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','98702A693645463E9FC0AC8899F339A7','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Líneas de recetas','icons\linearecetas.jpg','DMCatalogos.BrwLineas(2)',30,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','AA6F7B97C1BD4D0E9CFABABF193C1279','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Líneas de artículos y servicios','icons\lineas.jpg','DMCatalogos.BrwLineas()',31,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','413A4B12D6D0473F86FD312BED9122E0','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Marcas','icons\marcas.jpg','UIInventario.CatalogoMarcas()',32,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','836B72CB5C8E4D86802673F74CD9C990','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Departamentos','icons\departamentos.jpg','UIInventario.CatalogoDepartamentos()',33,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','D74DCDE6754240C7814812C3387280D1','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Categorías','icons\categorias.jpg',' Catalogos.BrwCategorias(0)',34,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','C31A854C93F74D71842381EF99A242EC','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Divisas','icons\divisas.jpg','Catalogos.BrwDivisas()',35,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','309B41715BD74223A4C30584D169CA7E','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Bancos','icons\banco.jpg','Catalogos.BrwBancos()',36,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','9E98A5DE016A4754A9ABCBFD04ECC685','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Tarjeta de Crédito','icons\tarjetas.JPG','Catalogos.BrwTarjetacredito()',37,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','08914BF3F4EB403A97EC5C17531D58FF','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Cajas','icons\cajas.JPG','Catalogos.BrwCajas()',38,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','191200B2389A45B48BCCC2A31351D419','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Zonas','icons\zonas.jpg','Catalogos.BrwZonas()',39,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','6B32943502424774818B00494259D4D2','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Países, Estados y Ciudades','icons\paises.jpg','Paises.ExplorerCountry()',40,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','4144F44F3AC5442897E5A9A7FF37106F','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Configuración de Impuestos','icons\impuestos.jpg','Catalogos.BrwCfgImpuestos()',41,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','F44DD1CB401145FBA3CB9B27590634E4','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Aduanas','icons\aduanas.jpg','UIGastos.CatalogoAduanas()',42,'*');

INSERT INTO ut_homepage(Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, uf_Tipo, uf_Titulo, uf_Imagen, uf_Funcion, uf_Orden, uf_grupos) VALUES ('2009-11-12 17:08:09','16BD4F48B08C11E397B9E129274AFD18','2009-11-12 17:08:09',NULL,NULL,0,'2009-11-12 17:08:09',NULL,1,'Tipos de póliza','icons\\TipoPolizas.jpg','UIFoliosPolizas.ShowBrowser()',43,'*');
...
CREATE TABLE ut_CFD (Sys_PK INT  NOT NULL IDENTITY (1,1) CONSTRAINT IDX_ut_CFD PRIMARY KEY, Sys_TimeStamp DATETIME  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL  UNIQUE , Sys_DTCreated DATETIME , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported BIT , Sys_DTExported DATETIME , Sys_Info VARCHAR(32),uf_XML VARCHAR(MAX) NOT NULL, uf_CadenaOriginal VARCHAR(MAX) NOT NULL, uf_SelloDigital VARCHAR(MAX) NOT NULL , uf_Presentacion VARCHAR(MAX), uf_IVenta INT, uf_CFDfolio INT,sys_recver int default 0,sys_deleted bit null,sys_lock int null);

CREATE TABLE ut_CFDbitacora (Sys_PK INT  NOT NULL IDENTITY (1,1) CONSTRAINT IDX_ut_CFDbitacora PRIMARY KEY, Sys_TimeStamp DATETIME  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL  UNIQUE , Sys_DTCreated DATETIME , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported BIT , Sys_DTExported DATETIME , Sys_Info VARCHAR(32),uf_Datos VARCHAR(MAX) NOT NULL , uf_Reportado BIT , uf_CFD INT NOT NULL UNIQUE,sys_recver int default 0,sys_deleted bit null,sys_lock int null );

CREATE TABLE ut_CFDInforme (Sys_PK INT  NOT NULL IDENTITY (1,1) CONSTRAINT IDX_ut_CFDInforme PRIMARY KEY, Sys_TimeStamp DATETIME  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL  UNIQUE , Sys_DTCreated DATETIME , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported BIT , Sys_DTExported DATETIME , Sys_Info VARCHAR(32), uf_Nombre VARCHAR(50), uf_Contenido VARCHAR(MAX), uf_Mes INT NOT NULL, uf_Anio INT NOT NULL, uf_fecha DATETIME,sys_recver int default 0,sys_deleted bit null,sys_lock int null );
...
CREATE TABLE ut_NotasLibres (Sys_PK INT NOT NULL IDENTITY(1,1) CONSTRAINT IDX_ut_NotasLibres PRIMARY KEY, Sys_TimeStamp DATETIME  NOT NULL, PKUsuario INT NOT NULL, PKMesero INT, PKCuenta INT, PKCProd INT NOT NULL, Notas VARCHAR (4096) NOT NULL);

CREATE VIEW qryRepCV2 AS  SELECT TOP 100 PERCENT qryCostoVentas.Codigo, qryCostoVentas.Descripcion, qryCostoVentas.UE AS Unidad, qryCostoVentas.PKProducto, qryCostoVentas.CantidadE AS Ventas, qryCostoVentas.Importe AS Importe, qryCostoVentas.Impuestos AS Impuestos, qryCostoVentas.Abonos AS Costo, ((Year(qryCostoVentas.Fecha)*10000)+(Month(qryCostoVentas.Fecha)*100)+Day(qryCostoVentas.Fecha)) AS ND_Fecha, Venta.IAgente, Venta.ICConsumo, Venta.ICliente, Cliente.Tipo FROM (Venta INNER JOIN Cliente ON Venta.ICliente=Cliente.Sys_PK) INNER JOIN qryCostoVentas ON qryCostoVentas.PKVenta=Venta.Sys_PK ORDER BY Venta.Sys_PK;  ;

CREATE VIEW qryRepCD2 AS  SELECT TOP 100 PERCENT qryDevCostoVenta.Codigo, qryDevCostoVenta.Descripcion, qryDevCostoVenta.UE AS Unidad, qryDevCostoVenta.PKProducto, qryDevCostoVenta.CantidadE AS Ventas, qryDevCostoVenta.Importe AS Importe, qryDevCostoVenta.Impuestos AS Impuestos, qryDevCostoVenta.Cargos AS Costo, ((Year(qryDevCostoVenta.Fecha)*10000)+(Month(qryDevCostoVenta.Fecha)*100)+Day(qryDevCostoVenta.Fecha)) AS ND_Fecha, Venta.IAgente, Venta.ICConsumo, Venta.ICliente, Cliente.Tipo FROM (Venta INNER JOIN Cliente ON Venta.ICliente=Cliente.Sys_PK) INNER JOIN qryDevCostoVenta ON qryDevCostoVenta.PKVenta=Venta.Sys_PK ORDER BY Venta.Sys_PK; ;

CREATE VIEW qryRepC2 AS  Select qryRepCV2.PKProducto,qryRepCV2.Codigo, qryRepCV2.Descripcion, qryRepCV2.Unidad, qryRepCV2.ND_Fecha, qryRepCV2.IAgente, qryRepCV2.ICConsumo, qryRepCV2.ICliente, qryRepCV2.Tipo, Sum(qryRepCV2.Ventas) As Ventas, Sum(qryRepCV2.Importe) as Importe,Sum(qryRepCV2.Impuestos) as ImpuestosVenta, Sum(qryRepCV2.Costo) As Costo,0 as Devoluviones,0 as ImpDev,0 as  ImpuestosDev,0 as CostoDev From qryRepCV2 group by qryRepCV2.PKProducto,qryRepCV2.Codigo, qryRepCV2.Descripcion, qryRepCV2.Unidad, qryRepCV2.ND_Fecha, qryRepCV2.IAgente, qryRepCV2.ICConsumo, qryRepCV2.ICliente, qryRepCV2.Tipo  UNION ALL Select qryRepCD2.PKProducto,qryRepCD2.Codigo, qryRepCD2.Descripcion, qryRepCD2.Unidad,qryRepCD2.ND_Fecha, qryRepCD2.ICConsumo, qryRepCD2.IAgente, qryRepCD2.ICliente, qryRepCD2.Tipo, 0 As Ventas,0 As Importe,0 as ImpuestosVenta, 0 As Costo, Sum(qryRepCD2.Ventas) As Devoluciones, Sum(qryRepCD2.Importe) as ImpDev, Sum(qryRepCD2.Impuestos) as ImpuestosDev, Sum(qryRepCD2.Costo) As CostoDev From qryRepCD2 group by qryRepCD2.PKProducto,qryRepCD2.Codigo, qryRepCD2.Descripcion, qryRepCD2.Unidad, qryRepCD2.ND_Fecha, qryRepCD2.IAgente, qryRepCD2.ICConsumo, qryRepCD2.ICliente, qryRepCD2.Tipo;

CREATE VIEW qryRepCostoVentas2 AS  SELECT TOP 100 PERCENT qryrepc2.PKProducto, qryrepc2.Codigo, qryrepc2.Descripcion, qryrepc2.Unidad, qryrepc2.ND_Fecha, qryrepc2.IAgente, qryrepc2.ICConsumo, qryrepc2.ICliente, qryrepc2.Tipo, sum(qryrepc2.Ventas) AS Ventas, sum(qryrepc2.Importe) AS Importe, sum(qryrepc2.ImpuestosVenta) AS ImpuestosV, Sum(qryrepc2.Costo) AS Costo, Sum(qryrepc2.Devoluviones) AS Devoluciones, Sum(qryrepc2.ImpDev) AS ImpDev, sum(qryrepc2.ImpuestosDev) AS DevImpuestos, Sum(qryrepc2.CostoDev) AS CtDev FROM qryrepc2 GROUP BY qryrepc2.PKProducto, qryrepc2.Codigo, qryrepc2.Descripcion, qryrepc2.Unidad, qryrepc2.ND_Fecha, qryrepc2.IAgente, qryrepc2.ICConsumo, qryrepc2.ICliente, qryrepc2.Tipo ORDER BY qryrepc2.Descripcion;
