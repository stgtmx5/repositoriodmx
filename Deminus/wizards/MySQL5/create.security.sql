...
CREATE TABLE TUser (Sys_PK INT  NOT NULL AUTO_INCREMENT, PRIMARY KEY (Sys_PK), Sys_TimeStamp DATETIME  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL UNIQUE, Sys_DTCreated DATETIME , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported BOOL , Sys_DTExported DATETIME , Sys_Info VARCHAR(32), Locked BOOL , Message VARCHAR(255), Notes VARCHAR(32000), PWD VARCHAR(32), UserID VARCHAR(32) NOT NULL  UNIQUE , UserName VARCHAR(100) NOT NULL,pwdmd5 VARCHAR(35),sys_recver int default 0,sys_deleted bit null,sys_lock int null );
CREATE TABLE UserGroup (Sys_PK INT  NOT NULL AUTO_INCREMENT, PRIMARY KEY (Sys_PK), Sys_TimeStamp DATETIME  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL UNIQUE, Sys_DTCreated DATETIME , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported BOOL , Sys_DTExported DATETIME , Sys_Info VARCHAR(32), Description VARCHAR(80) NOT NULL , GroupID VARCHAR(15) NOT NULL  UNIQUE , Notes VARCHAR(32000),uf_hidetoolbar VARCHAR(1),sys_recver int default 0,sys_deleted bit null,sys_lock int null);
CREATE TABLE UserVar (Sys_PK INT  NOT NULL AUTO_INCREMENT, PRIMARY KEY (Sys_PK), Sys_TimeStamp DATETIME  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL UNIQUE, Sys_DTCreated DATETIME , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported BOOL , Sys_DTExported DATETIME , Sys_Info VARCHAR(32), VarDefault VARCHAR(255), VarName VARCHAR(32) NOT NULL UNIQUE, VarValue VARCHAR(32000), fUser INT  NOT NULL,sys_recver int default 0,sys_deleted bit null,sys_lock int null );
...
CREATE TABLE sisFirma (Sys_PK INT  NOT NULL AUTO_INCREMENT, PRIMARY KEY (Sys_PK), Sys_TimeStamp DATETIME  NOT NULL , Sys_GUID VARCHAR(32) NOT NULL UNIQUE, Sys_DTCreated DATETIME , Sys_User VARCHAR(5), Sys_LastUser VARCHAR(5), Sys_Exported BOOL , Sys_DTExported DATETIME , Sys_Info VARCHAR(32), Aplicacion VARCHAR(32) NOT NULL , Archivo VARCHAR(50), Firma VARCHAR(50) NOT NULL UNIQUE,sys_recver int default 0,sys_deleted bit null,sys_lock int null);
...
INSERT INTO GlobalVar (Sys_TimeStamp, Sys_GUID, Sys_DTCreated, Sys_User, Sys_LastUser, Sys_Exported, Sys_DTExported, Sys_Info, VarName, VarValue) VALUES (NOW(),'1F0B903EF4EA41E1AD9CD6920296EC00',NOW(),NULL,NULL,NULL,NULL, NULL, 'DB_SCHEMA_VER', '3.3');
